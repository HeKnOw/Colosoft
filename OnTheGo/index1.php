...
mysql_select_db("thehite1_restaurant", $con) or die ('not found');
$error='';
$success='';
...
{   
    ...
    if($_POST['action']=="SIGNIN") //($_POST['action']=="LOGIN")
    {
        if($user=="alex")
        {
            echo "im here";
        ...
        {
            $userOnDB=mysql_query("SELECT USERNAME, PASSWORD FROM users WHERE USERNAME ='$username'");
            $i = 0;
            while($row = mysql_fetch_array($userOnDB))
            {
                $rows[$i] = $row;
                $i++;
            }
            ...
            if($rows[0]["USERNAME"] == $username && $rows[0]["PASSWORD"] != $password)
            {
                ...
                header("location:profile.php#Wrong");
            }
								...
								<div class="container-fluid">
									...
									<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav">
											...
											<li class="dropdown hidden-xs">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="img/nav-menu/nav5.jpg" class="img-responsive" alt="" /> Italian<b class="caret"></b></a>
												<ul class="dropdown-menu dropdown-md">
													<li>
														<div class="row">
															<div class="col-md-4 col-sm-6">
																...
																<div class="menu-item">
																	...
																	<h3>Pizza</h3>
																	<!-- Image -->
																	<img src="img/dish/dish4.jpg" class="img-responsive" alt="" />
																	<!-- Paragraph -->
											...
											<li class="dropdown visible-xs">
												...
												<ul class="dropdown-menu">
													...
													<li><a href="index1.php">Pasta</a></li>
																						...
																						<li class="dropdown hidden-xs">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="img/nav-menu/nav6.jpg" class="img-responsive" alt="" /> Asian<b class="caret"></b></a>
												<ul class="dropdown-menu dropdown-md">
													<li>
														<div class="row">
															<div class="col-md-4 col-sm-6">
															...
															<div class="col-md-4">
																...
																<div class="menu-item">
																	...
																	<h3>Kung-Pao</h3>
																	<!-- Image -->
																	<img src="img/dish/dish9.jpg" class="img-responsive" alt="" />
																	<!-- Paragraph -->
											...
											<li class="dropdown visible-xs">
												...
												<ul class="dropdown-menu">
													...
													<li><a href="index1.php">Kung-Pao</a></li>
																																	...
																																	<li class="dropdown hidden-xs">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="img/nav-menu/nav7.jpg" class="img-responsive" alt="" /> Others<b class="caret"></b></a>
												<ul class="dropdown-menu dropdown-md">
													<li>
														<div class="row">
															<div class="col-md-4 col-sm-6">
																...
																<div class="menu-item">
																	...
																	<!-- Image -->
																	<img src="img/dish/dish10.jpg" class="img-responsive" alt="" />
																	<!-- Paragraph -->
															...
															<div class="col-md-4">
																...
																<div class="menu-item">
																	...
																	<h3>Greek</h3>
																	<!-- Image -->
																	<img src="img/dish/dish12.jpg" class="img-responsive" alt="" />
																	<!-- Paragraph -->
							...
							<div class="footer-widget">
								...
								<p>There is no one who loves pain itself, who seeks after it and wants to have it.</p>
                                    ...
                                    <div id="Wrong">
                                        <p style="color:red">
                                        <?php 
                                            if($_SESSION['Wrongpass']=="Wrong Password!")
                                            {
                                                echo "Wrong password or Username already taken";
                                            }
                                            else if($error=="Username alredy taken")
                                            {
                                                echo $error;
                                            }
                                        ?>
								...
								<!-- Subscribe form -->
								<form method="post" action="index1.php" enctype="multipart/form-data" id="usersign-in">
									...
									<button name="action" class="btn btn-danger" value="SIGNIN" type="submit">Sign In</button>
								</form>
							</div> <!--/ Footer widget end -->
						</div>
						<div class="col-md-3 col-sm-6">
